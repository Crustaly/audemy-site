...
<template>
  <div class="relative flex justify-center w-full pl-40 pr-20 mt-20 mb-32">
    ...
    <div
      ...
      <div class="my-8">
        <h2 class="text-left font-poppins text-4.5xl tablet:text-[32px] mobile:text-[24px] mobile:text-center font-[400]">
          Trusted by Leading Publications</h2>
      </div>
      ...
      <div class="flex justify-center">
        <div class="w-full">
          <div id="div_about_us"
            ...
            <PressListCard v-for="item in items" :image="item.image" :text="item.text" :author="item.author"
    ...
    <img src="/src/assets/images/impact/orangeStar.png" class="absolute left-[18rem] bottom-[0rem]" alt="image" />
    <img src="/src/assets/images/impact/blueStar.png" class="absolute right-[16rem] bottom-[35rem]" alt="image" />
